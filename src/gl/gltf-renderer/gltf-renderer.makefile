test/load_GLfloat3: src/gl/buffer/accessor_loaders/test/load_GLfloat3.test.o
test/load_GLfloat3: src/gl/buffer/accessor_loaders/load_GLfloat3.o
test/load_GLfloat3: src/gl/buffer/accessor_loaders/load_indices.o
...
test/gltf-renderer: src/gl/buffer/accessor_loaders/load_GLfloat3.o
test/gltf-renderer: src/gl/buffer/accessor_loaders/load_indices.o
