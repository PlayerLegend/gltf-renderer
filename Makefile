...
src/json/traverse.o: src/range/def.h src/keyargs/keyargs.h src/json/def.h
src/json/json.o: src/range/def.h src/window/def.h src/window/alloc.h
src/json/json.o: src/keyargs/keyargs.h src/json/def.h src/json/parse.h
src/json/json.o: src/json/traverse.h src/log/log.h src/list/list.h
src/json/json.o: src/libc/string-extensions.h src/table/table.h
src/json/json.o: src/table/table-string.h
src/json/parse.o: src/range/def.h src/keyargs/keyargs.h src/json/def.h
src/libc/strdup/strdup.o: src/libc/string-extensions.h
src/uri/uri.o: src/range/def.h src/range/string.h src/window/def.h
src/uri/uri.o: src/window/alloc.h src/window/vprintf.h src/window/printf.h
src/uri/uri.o: src/window/string.h src/convert/def.h src/convert/fd.h
src/uri/uri.o: src/uri/uri.h src/log/log.h
...
src/gl/mesh/def.o: src/gltf/def.h src/json/def.h src/window/alloc.h
src/gl/mesh/def.o: glad/include/glad/glad.h glad/include/KHR/khrplatform.h
src/gl/mesh/def.o: src/range/def.h src/window/def.h src/vec/vec.h
src/gl/mesh/def.o: src/vec/vec3.h src/vec/vec4.h src/keyargs/keyargs.h
src/gl/mesh/def.o: src/json/def.h src/gltf/def.h
...
src/gl/gltf-renderer/gltf-renderer.test.o: src/json/def.h src/gltf/def.h
...
src/gl/gltf-renderer/gltf-renderer.test.o: src/ui/input.h src/ui/time.h
...
src/gl/buffer/def.o: src/vec/vec3.h src/vec/vec4.h src/gl/mesh/def.h
src/gl/buffer/def.o: src/json/def.h src/gl/buffer/internal/def.h
...
src/gl/buffer/loader.o: src/gltf/def.h src/gltf/env.h src/gltf/parse.h
src/gl/buffer/loader.o: src/convert/def.h src/gltf/convert.h src/uri/uri.h
src/gl/buffer/loader.o: src/log/log.h src/vec/vec4.h src/vec/mat4.h
src/gl/buffer/loader.o: src/gl/mesh/def.h src/json/def.h
src/gl/buffer/loader.o: src/gl/buffer/internal/def.h src/gl/buffer/loader.h
...
src/gl/buffer/draw.o: src/vec/mat4.h src/json/def.h src/gltf/def.h
src/gl/buffer/draw.o: src/gl/mesh/def.h src/json/def.h
src/gl/buffer/draw.o: src/gl/buffer/internal/def.h src/gl/buffer/draw.h
src/gl/buffer/loader.o: glad/include/glad/glad.h
src/gl/buffer/loader.o: glad/include/KHR/khrplatform.h src/range/def.h
...
src/gl/buffer/draw.o: src/range/def.h src/window/def.h src/vec/vec.h
src/gl/buffer/draw.o: src/vec/vec3.h src/vec/vec4.h src/keyargs/keyargs.h
src/gl/buffer/draw.o: src/vec/mat4.h src/gltf/def.h src/gl/mesh/def.h
src/gl/buffer/draw.o: src/json/def.h
...
src/gl/buffer/internal/def.o: src/vec/vec4.h src/json/def.h src/gltf/def.h
...
src/gltf/parse.o: src/range/def.h src/json/def.h
src/gltf/env.o: src/range/def.h src/window/def.h src/vec/vec.h src/vec/vec3.h
src/gltf/env.o: src/json/def.h
...
src/gltf/gltf.o: src/json/traverse.h src/json/def.h
src/gltf/convert.o: src/range/def.h src/keyargs/keyargs.h src/json/def.h
src/gltf/convert.o: src/window/def.h src/window/alloc.h src/convert/def.h
src/gltf/convert.o: src/json/def.h src/json/parse.h
...
src/window/printf.o: src/range/def.h src/json/def.h src/window/printf.h
src/window/printf.o: src/window/alloc.h src/window/vprintf.h
src/window/vprintf_append.o: src/range/def.h src/json/def.h
src/window/vprintf_append.o: src/window/vprintf.h src/window/alloc.h
src/window/string.o: src/range/def.h src/json/def.h src/window/alloc.h
src/window/string.o: src/window/string.h
src/window/vprintf.o: src/range/def.h src/json/def.h
src/window/alloc.o: src/window/def.h
src/window/printf.o: src/range/def.h src/json/def.h
src/window/printf_append.o: src/range/def.h src/json/def.h
...
src/window/alloc.o: src/window/string.h src/range/def.h src/json/def.h
src/window/alloc.o: src/window/alloc.h
src/window/string.o: src/window/string.h src/range/def.h src/json/def.h
src/window/string.o: src/window/alloc.h
src/window/vprintf.o: src/range/def.h src/json/def.h src/window/vprintf.h
src/window/vprintf.o: src/window/alloc.h
src/physics/trace/def.o: src/vec/vec.h src/vec/vec3.h
src/physics/trace/line.o: src/vec/vec.h src/vec/vec3.h src/json/def.h
src/physics/trace/line.o: src/range/def.h src/gl/mesh/def.h
src/physics/trace/line.o: src/physics/trace/line.h
src/physics/trace/line.o: src/vec/vec.h src/vec/vec3.h src/json/def.h
src/physics/trace/line.o: src/range/def.h src/gl/mesh/def.h
src/physics/ellipsoid/def.o: src/vec/vec.h src/vec/vec3.h src/json/def.h
...
src/physics/mesh/build.o: src/window/alloc.h src/json/def.h
src/physics/mesh/build.o: src/physics/mesh/build.h src/log/log.h
src/physics/mesh/load.o: glad/include/glad/glad.h
src/physics/mesh/load.o: glad/include/KHR/khrplatform.h src/vec/vec.h
src/physics/mesh/load.o: src/vec/vec3.h src/range/def.h src/window/def.h
src/physics/mesh/load.o: src/window/alloc.h src/vec/range_vec3.h
src/physics/mesh/load.o: src/convert/def.h src/json/def.h
src/physics/mesh/load.o: src/keyargs/keyargs.h src/gltf/def.h src/gltf/env.h
src/physics/mesh/load.o: src/gltf/convert.h src/log/log.h
src/physics/mesh/load.o: src/physics/mesh/build.h
...
src/physics/mesh/GLfloat3.o: src/json/def.h
...
src/physics/mesh/subset.o: src/window/def.h src/json/def.h
src/physics/mesh/build.o: src/vec/vec.h src/vec/vec3.h src/range/def.h
src/physics/mesh/build.o: src/window/def.h src/json/def.h
src/physics/mesh/subset.o: src/vec/vec.h src/vec/vec3.h src/range/def.h
src/physics/mesh/subset.o: src/window/def.h src/json/def.h
...
src/range/range_streq_string.o: src/window/string.h src/json/def.h
src/range/range_atozd.o: src/json/def.h src/window/string.h
src/range/string.o: src/json/def.h src/window/string.h
...
src/convert/getline.o: src/window/def.h src/window/alloc.h src/json/def.h
src/convert/getline.o: src/convert/getline.h src/log/log.h
src/convert/fd-bifurcated.o: src/window/def.h src/json/def.h
src/convert/fd.o: src/range/def.h src/window/def.h src/window/alloc.h
src/convert/fd.o: src/json/def.h src/convert/fd.h src/log/log.h
src/convert/def.o: src/range/def.h src/window/def.h src/window/alloc.h
src/convert/def.o: src/json/def.h src/log/log.h
src/convert/fd.o: src/range/def.h src/window/def.h src/json/def.h
src/convert/getline.o: src/range/def.h src/window/def.h src/json/def.h
src/convert/fd-bifurcated.o: src/window/def.h src/window/alloc.h
src/convert/fd-bifurcated.o: src/json/def.h src/convert/fd-bifurcated.h
...
src/lang/preprocessor/preprocessor.o: src/window/string.h src/range/def.h
src/lang/preprocessor/preprocessor.o: src/window/def.h src/convert/def.h
src/lang/preprocessor/preprocessor.o: src/table/table.h
